...
class Etat_Paie_controller extends Controller
{
    ...
    public function etat_de_paie($dateDebut, $dateFin, $idEmploye) {
        ...
        $table["salaire_brut"] = $salaire_brut;
        ...
        $table["montant_imposable"] = $montant_imposable;
        $table["liste_tranche"] = $liste_tranche;
        $table["avantage_en_nature"] = $avantage_en_nature;
        $table["liste_enfants"] = $liste_enfants;
        $table["montant_enfant_charge"] = (count($liste_conge))*2000;
        $table["retenu_1%_CNAPS"] = (new CNAPS())->getRetenu_CNAPS_Un_Employe($salaire_brut);
        $table["impot"] = (new Impot())->getImpot_Du($salaire_brut);
        ...
        $table["salaire_net"] = $salaire_brut - $table["total_retenues"];
        $table["avance"] = $avance;
    ...
    public function listes_etat_de_paie(Request $request){
        ...
        return view("paie/etat_de_paie", compact("listes_employer"));
