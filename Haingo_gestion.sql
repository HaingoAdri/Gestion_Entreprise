...
--
-- Name: seqimmobilisation_reception; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seqimmobilisation_reception
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.seqimmobilisation_reception OWNER TO postgres;
...
DU00002	PU00000001	I_R0004	Azo ampiasaina faha tsy vaovaoa	4	40
DU00001	PU00000001	I_R0003	Pc second main	2	45
\.
...
PU00000001	PR00000010	6	2024-01-01
\.
...
SELECT pg_catalog.setval('public.seq_details_utilisation', 2, true);
...
SELECT pg_catalog.setval('public.seq_inventaire', 1, false);
...
SELECT pg_catalog.setval('public.seq_pv_utilisation', 1, true);
...
--
-- Name: seqimmobilisation_reception; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.seqimmobilisation_reception', 1, false);
