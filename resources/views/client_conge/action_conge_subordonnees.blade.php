        ...
        <div class="col-lg-3"></div>
            <div class="col-lg-6" >
                ...
                <div class="card-body slim-scroll">
                            ...
                            <div class="modal fade" id="modal-add-event" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="card-header align-items-left px-3 px-md-5">
                                    <div class="text-left"> <!-- Change text-right to text-left -->
                                        <a href="{{ route('changeStatut_Subordonnees', ['id' => $demande->id, 'statut' => 20 ]) }}"><button type="button" class="btn btn-primary"> 
                                            Valider
                                        </button></a>
                                        <a href="{{ route('changeStatut_Subordonnees', ['id' => $demande->id, 'statut' => 40 ]) }}"><button type="button" class="btn btn-primary"> 
                                            Refuser
                                        </button></a>
                                    </div>
                    ...
                    <div class="card-header align-items-left px-3 px-md-5">
                        <div class="text-left"> <!-- Change text-right to text-left -->
                            <a href="{{ route('ajout_Conge') }}"><button type="button" class="btn btn-primary"> 
                                Retour
                            </button></a>
                        </div>
