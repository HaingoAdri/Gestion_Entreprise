    ...
    <div class="content"><!-- Card Profile -->
        ...
        <div class="card-footer card-profile-footer">
            <ul class="nav nav-border-top justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('liste_retour') }}">Confirmation Fin</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-lg-3"></div>
            <div class="col-lg-6" >
                ...
                <div class="card-body slim-scroll">
                    <ul class="list-group">
                    @if( count($demandes_retour) > 0)
                        @foreach($demandes_retour as $demande)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-event">
                                                <i class="mdi mdi-plus mr-1"></i> fin
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="modal-add-event" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <form action="{{ route('insertion_confirmation_fin') }}">

                                            <div class="modal-header px-4">
                                                <h5 class="modal-title" id="exampleModalCenterTitle">Confirmation Retour pour: {{ $demande->employer->client->nom }} {{ $demande->employer->client->prenom }}</h5>
                                            ...
                                            <div class="modal-footer border-top-0 px-4 pt-0">
                                                <button type="submit" class="btn btn-primary btn-pill m-0">Fin</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
