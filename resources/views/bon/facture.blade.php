                                        ...
                                        <div class="row gutters">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="custom-actions-btns mb-5">
                                                    <a href="{{ route('export_PDF', ['idBonCommande' => $bonCommande->id]) }}" class="btn btn-primary">
                                                        <i class="icon-download"></i> Exporter PDF
                                                    </a>
                                                    <a href="{{ route('fin_bon_commande', ['idBonCommande' => $bonCommande->id]) }}" class="btn btn-secondary">
                                                        <i class="icon-printer"></i> Valider
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
